...
public class Fecha {
	 ...
	 * @throws ErrorDiaException indica valor de parametro de entrada erroneo
	 * @throws ErrorMesException indica valor de parametro de entrada erroneo
	 */
	public Fecha(int dia, int mes, int año) throws ErrorDiaException, ErrorMesException {
		// si dia menor o igual a 0 lanzo excepcion
		if (dia <= 0) {
			throw new ErrorDiaException();
		}
		// si mes menor o igual a 0 lanzo excepcion
		if (mes <= 0) {
			throw new ErrorMesException();
		}
	 ...
	 * @throws ErrorMesException indica valor de parametro de entrada erroneo
	 */
	public void setMes(int mes) throws ErrorMesException {
